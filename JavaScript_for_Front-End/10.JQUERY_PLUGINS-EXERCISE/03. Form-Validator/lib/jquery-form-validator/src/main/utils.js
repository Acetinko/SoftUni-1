...
(function($, window) {
  ...
  $.formUtils = $.extend($.formUtils || {}, {
    ...
    validateInput: function ($elem, language, conf, $form, eventContext) {
      ...
      // Therefore, we cannot distinguish (apart from hacks) between an empty input type="textBox" and one with a
    ...
    lengthRestriction: function ($inputElement, $maxLengthElement) {
      // read maxChars from counter display initial textBox value
