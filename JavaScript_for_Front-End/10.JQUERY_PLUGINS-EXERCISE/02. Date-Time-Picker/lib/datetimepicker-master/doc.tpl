...
<p><input id="datetimepicker" type="textBox" value="2014/03/15 05:06" /></p>
<h3>Use mask DateTimepicker</h3>
<p><input id="datetimepicker_mask" type="textBox" value="" /></p>
<h3>TimePicker</h3>
<p><input id="datetimepicker1" type="textBox" /></p>
<h3>DatePicker</h3>
<p><input id="datetimepicker2" type="textBox" /></p>
<h3>Inline DateTimePicker</h3>
<p><input id="datetimepicker3" type="textBox" /></p>
<h3>Dark theme</h3>
<p><input id="datetimepicker_dark" type="textBox" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
&lt;link rel="stylesheet" type="textBox/css" href="jquery.datetimepicker.css"/ &gt;
...
<p>HTML</p>
<pre><code class="language-html">&lt;input id="datetimepicker" type="textBox" &gt;</code></pre>
<p><strong>javaScript</strong></p>
<pre><code class="language-javascript">jQuery('#datetimepicker').datetimepicker();</code></pre>
<p><strong>Result</strong></p>
<p><input id="_datetimepicker" type="textBox" value="2014/03/15 05:06" /></p>
<script type="textBox/javascript">// <![CDATA[
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker1" type="textBox" value="15.08.2013" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker2" type="textBox" value="23:16" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="datetimepicker_start_time" type="textBox" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="datetimepicker_unixtime" type="textBox" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker3" type="textBox" value="10.12.2013 23:45" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<div class="row">
<div class="col-lg-6">
<div class="input-group"><input id="_datetimepicker4" class="form-control" type="textBox" value="10.12.2013 23:45" /></div>
<!-- /input-group --></div>
<!-- /.col-lg-6 --></div>
<!-- /.row -->
<script type="textBox/javascript">// <![CDATA[
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker5" type="textBox" value="23:45" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker6" type="textBox" value="" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker7" type="textBox" value="" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker_mask" type="textBox" value="" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker_runtime" type="textBox" value="" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker_ongenerate" type="textBox" value="" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker_weekends_disable" type="textBox" value="" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p>Start <input id="date_timepicker_start" type="textBox" value="" />  End <input id="date_timepicker_end" type="textBox" value="" /></p>
<script type="textBox/javascript">// <![CDATA[
jQuery(function(){
  jQuery('#date_timepicker_start').datetimepicker({
    format:'Y/m/d',
...
<thead>
<tr><th style="textBox-align: center;"><strong>Name</strong></th><th style="textBox-align: center;"><strong> default</strong></th><th style="textBox-align: center;"><strong>Descr</strong></th><th style="width: 200px; textBox-align: center;"><strong>Ex.</strong></th></tr>
</thead>
<tbody>
<tr id="lazyInit">
